...
[age_cat, ~] = normalyze(age_cat, 1);
                                            ...
                                            all_features = horzcat(full_image_features, age_cat, bmi, cumulus_da, sqrt(cumulus_pd));
                                            dense_features = horzcat(dense_image_features, age_cat, bmi, cumulus_da, sqrt(cumulus_pd));
                                            normal_features = horzcat(normal_image_features, age_cat, bmi, cumulus_da, sqrt(cumulus_pd));
