                 ...
                 [all_features] = createHistogramFeatures( ...
                   ...
                   [dense_features] = createHistogramFeatures( ...
                        ...
                        [normal_features] = createHistogramFeatures( ...
                                             ...
                                             all_features = horzcat(all_features, sqrt(cumulus_pd));
                                             dense_features = horzcat(dense_features, sqrt(cumulus_pd));
                                             normal_features = horzcat(normal_features, sqrt(cumulus_pd));
